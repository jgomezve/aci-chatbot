...
type ApicClientMocks struct {
	...
	GetLastestFaultsF       func(c string) ([]ApicMoAttributes, error)
}
...
func (ac *ApicClientMocks) GetLastestFaults(c string) ([]ApicMoAttributes, error) {
	return ac.GetLastestFaultsF(c)
}
